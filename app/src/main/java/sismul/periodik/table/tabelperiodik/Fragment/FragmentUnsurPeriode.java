...
import sismul.periodik.table.tabelperiodik.Adapter.UnsurPeriodeAdapter;
...
public class FragmentUnsurPeriode extends Fragment {
    private List<Unsur> uGolonganValues = new ArrayList<>();
    private RecyclerView recyclerView;
    private UnsurPeriodeAdapter mAdapter;
    private Context mContext;

    public static FragmentUnsurPeriode newInstance() {
        FragmentUnsurPeriode fragment = new FragmentUnsurPeriode();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<Unsur>> call = apiService.getPeriode(id);
        call.enqueue(new Callback<List<Unsur>>() {
            ...
            public void onResponse(Call<List<Unsur>> call, Response<List<Unsur>> response) {
                ...
                recyclerView.setAdapter(new UnsurPeriodeAdapter(ugs, R.layout.unsur_item_row, mContext));
            }
